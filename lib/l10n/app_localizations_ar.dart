...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get rememberCredentials =>
      'تذكر بيانات الاعتماد وتسجيل الدخول التلقائي';
  ...
  String get rememberCredentialsDesc =>
      'حفظ بيانات الاعتماد وتسجيل الدخول التلقائي';
  ...
  String get clearLogsConfirmation =>
      'هل أنت متأكد من أنك تريد مسح جميع السجلات؟ لا يمكن التراجع عن هذا الإجراء.';
