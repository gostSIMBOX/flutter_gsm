...
/// Windows platform implementation of [FlutterGsmPlatform]
///
...
/// sdd-asterisk-chan-simbox provides a real driver (COM-port serial on
/// Windows).
class WindowsFlutterGsm extends FlutterGsmPlatform {
  static void registerWith() {
    FlutterGsmPlatform.instance = WindowsFlutterGsm();
  }
