...
class UsbDongleSource implements IUsbDongleSource {
  ...
  Future<DongleStatus> getStatus() async {
    try {
      ...
      final connected = interfaceType != DongleInterfaceType.none;
      
      return DongleStatus(
        connected: connected,
        interfaceType: interfaceType,
        quality: connected ? QualityLevel.great : QualityLevel.poor,
      );
    } catch (e) {
      debugPrint('UsbDongleSource.getStatus error: $e');
