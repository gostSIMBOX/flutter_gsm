...
class GatewayService {
  ...
  Future<bool> start() async {
    try {
      ...
      // Register SIP account (convert entity to model)
      final sipAccount = _config!.sipAccount;
      final sipAccountModel = SipAccountModel.fromEntity(sipAccount);
      await _sipService.createAccount(sipAccountModel);
